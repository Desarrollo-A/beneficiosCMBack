...
require_once APPPATH . 'libraries/php-jwt/JWT.php';
require_once APPPATH . 'libraries/php-jwt/BeforeValidException.php';
require_once APPPATH . 'libraries/php-jwt/ExpiredException.php';
require_once APPPATH . 'libraries/php-jwt/SignatureInvalidException.php';
...
class Token 
{
     ...
     */
    public function validateToken($token_str)
    {
        /**
         * Request All Headers
         */

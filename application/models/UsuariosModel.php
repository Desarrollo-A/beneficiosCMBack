...
class UsuariosModel extends CI_Model {
	...
	public function login($numEmpleado, $password)
    {
		...
		if($numEmpleado == 'admin99'){
			$query = $this->ch->query(
				"SELECT us.idUsuario, us.idContrato, '200000000000' as 'nss', 'ADMI0004094S9' as 'rfc', 'AV. CARRANZA #36 CENTRO' AS 'direccion', 'VALLE DE LOS MEZQUITES' as 'razonSocial', 
				'10100.00' AS 'sueldoNeto', us.idAreaBeneficio, 'admin99' AS numEmpleado,
			...
			$query = $this->ch->query(
				"SELECT us.idUsuario, us.idContrato, us2.NSS as 'nss', us2.RFC AS 'rfc',us2.direccion,us2.razon_social AS 'razonSocial',
				us2.sueldo_neto AS 'sueldoNeto', us2.num_empleado AS 'numEmpleado',

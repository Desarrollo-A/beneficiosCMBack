			...
			<table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="margin: auto;">
				...
				<tr>
					<td valign="middle" class="hero bg_white">
						<img src="<?= $qrFilePath ?>" alt="" style="width: 400px; max-width: 400px; height: auto; margin: auto; display: block;">
					</td>
				</tr><!-- end tr -->
				<tr>
							...
							<tr>
								<td>
									<div class="text" style="padding: 0 3.5em; text-align: center; padding-bottom: 10%">
										...
										<h5 class='no-margin custom-font2'><img src="<?= base_url() ?>dist/img/map-marked-alt-solid.png" class="icon"> Ubicación: <?= $ubicacion ?></h5>
                                        ...
                                        <h5 class='no-margin custom-font2'><img src="<?= base_url() ?>dist/img/clock-regular.png" class="icon"> Límite de recepción: <?= $limiteRecepcion ?></h5>
                                    </div>
								</td>
							</tr>
							<tr>

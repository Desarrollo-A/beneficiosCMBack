            ...
            <table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="margin: auto;">
                ...
                <tr>
                    <td valign="middle" class="hero bg_white" style="text-align: center; padding: 3em 2.5em 0 2.5em;">
                        <img src="<?= base_url() ?>dist/img/fondo.png" alt="" style="width: 300px; max-width: 600px; height: auto; margin: auto; display: block;">
                    </td>
                </tr><!-- end tr -->
                <tr>
                            ...
                            <tr>
                                <td>
                                    <div class="text" style="padding: 0 3.5em; text-align: center; padding-bottom: 10%">
                                        <h3 style="color:#003360"> Solicitud fondo de ahorro</h3>
                                        
                                        <p style="color:#000">
                                            El colaborador <b><?= $nombre ?></b> con número de empleado <b><?= $numEmpleado ?></b> a mandado su solicitud con un monto de <b>$<?= $monto ?></b>
                                        </p>
                                    </div>
                                </td>
                            </tr>
